...
> **板块说明**：第五板块为补充阅读（Supplementary Reading）。前 82 章逐章解析 Claude Code 的源码机制、子系统结构和工程哲学，回答"是什么、怎么做"。本章换一个视角，把这些机制放回更宽的行业坐标系里，回答"这套做法在整个 Agent 工程演化史里属于什么范式，它叫什么名字，背后有什么争论"。

---

## 83.0 引子：为什么要多讲一章

前 82 章以 Claude Code 2.1.88 的源码为锚，讲 agent loop、工具调用、上下文压缩、子 agent、CLAUDE.md、Hooks、MCP……如果你跟到这里，你已经知道 Claude Code 是怎么运转的。
...
## 83.5 行业批评：Harness 是新范式还是旧概念换新衣
...
## 83.6 对照 Claude Code 源码：Harness 的核心要素在哪里
